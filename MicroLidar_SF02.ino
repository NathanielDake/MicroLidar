...
------------------------------------------
  This sketch demostrates three ways of connecting the SF02 laser range finder to the Arduino. These are:
  
    1. Connecting the auxilliary UART of the SF02 to a second serial port on the Arduino.
...
Method #1:: Using the auxilliary UART on the SF02
-------------------------------------------------
  ...
  The Arduino has a built-in serial port that is connected to its USB insterface.
...
The program
-----------
  This program reads the auxilliary UART, the analog output and the alarm of the SF02 every 0.5 seconds.
  ...
  Before using this program please make sure that the settings in the SF02 match the definintions given below.
*/
...
#define serial_port_rxd_pin               10                            // These pin definitions can be changed to match your prefered Arduino connections
...
//-- Read the auxilliary UART of the SF02 using the second serial port of the Arduino --
  sf02_serial.write("d");                                               // Trigger the auxilliary UART on the SF02 and...
